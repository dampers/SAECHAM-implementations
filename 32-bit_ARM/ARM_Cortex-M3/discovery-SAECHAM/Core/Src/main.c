...
extern void SAECHAM_enc_v5(const uint16_t* pt, uint16_t* ct, uint16_t* rk);
...
int main(void)
{
  /* USER CODE BEGIN 1 */
	...
	static unsigned int start, end, cycles, interv;
  /* USER CODE END 1 */
  ...
  while (1)
  {
    ...
    /* USER CODE BEGIN 3 */
	  ...
	  cycles = end - start;
	  printf("SAECHAM_enc_v1 clock cycles : %u\r\n", cycles-interv);
	  ...
	  cycles = end - start;
	  printf("SAECHAM_enc_v2 clock cycles : %u\r\n", cycles-interv);
	  printf("0x%04X 0x%04X 0x%04X 0x%04X\r\n", ct[0], ct[1], ct[2], ct[3]);
	  HAL_Delay(500);
	  ...
	  cycles = end - start;
	  printf("SAECHAM_enc_v3 clock cycles : %u\r\n", cycles-interv);
	  printf("0x%04X 0x%04X 0x%04X 0x%04X\r\n", ct[0], ct[1], ct[2], ct[3]);
	  HAL_Delay(500);
	  ...
	  cycles = end - start;
	  printf("SAECHAM_enc_v4 clock cycles : %u\r\n", cycles-interv);
	  printf("0x%04X 0x%04X 0x%04X 0x%04X\r\n", ct[0], ct[1], ct[2], ct[3]);
	  HAL_Delay(500);

	  start = DWT->CYCCNT;
	  SAECHAM_enc_v5(pt, ct, rk);
	  end = DWT->CYCCNT;
	  cycles = end - start;
	  printf("SAECHAM_enc_v5 clock cycles : %u\r\n", cycles-interv);
	  printf("0x%04X 0x%04X 0x%04X 0x%04X\r\n", ct[0], ct[1], ct[2], ct[3]);
	  HAL_Delay(500);
